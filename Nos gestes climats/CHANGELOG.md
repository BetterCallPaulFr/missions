...
- Refactor: fix model typings ([#2466](https://github.com/incubateur-ademe/nosgestesclimat/pull/2466))
- Feat: API changes for the frontend ([#198](https://github.com/incubateur-ademe/nosgestesclimat-server/pull/198))
...
- Feat: store CMS images on scaleway ([#3](https://github.com/incubateur-ademe/nosgestesclimat-cms/pull/3))
